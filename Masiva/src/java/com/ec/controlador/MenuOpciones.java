...
public class MenuOpciones extends SelectorComposer<Component> {
    ...
    @Listen("onClick = #btnReporteDetallado")
    public void dobtnReporteDetallado() {
        Executions.sendRedirect("/compra/detallecomprassri.zul");
    }
    ...
    @Listen("onClick = #btnListarRetenciones")
    public void btnListarRetenciones() {
        Executions.sendRedirect("/compra/listaretencionessri.zul");
    }
    ...
    @Listen("onClick = #btnListaVentasSRI")
    public void btnListaVentasSRI() {
        Executions.sendRedirect("/venta/listaventasssri.zul");
    }
